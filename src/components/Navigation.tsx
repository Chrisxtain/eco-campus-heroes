      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/features" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
              Features
            </Link>
            <Link to="/how-it-works" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
              How It Works
            </Link>
            <Link to="/blog" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
              Blog
            </Link>
            <Link to="/rewards" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
              Rewards
            </Link>
            <Link to="/contact" className="text-gray-700 hover:text-emerald-600 transition-colors font-semibold">
              Contact
            </Link>
          </div>
